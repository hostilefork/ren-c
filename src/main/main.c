...
//
// This is the %main-startup.r file bundled with other modules, compressed
...
//
#include "tmp-main-startup.h"  // generated by %prep-main.r
  ...
  //    runtime checks disallowing mutable extractions of const pointers.
    ...
    Value* startup_bin = rebValue(
        "gunzip", rebR(rebHandle(  // uncompress [1]
            m_cast(unsigned char*, &g_main_startup_code[0]),  // mutable [2]
            g_main_startup_size,
            nullptr
        ))
    );
