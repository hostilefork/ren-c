...
#define STUB_SUBCLASS_FLAG_24_ALSO_CELL_FLAG_CONST  FLAG_LEFT_BIT(24)
STATIC_ASSERT(STUB_SUBCLASS_FLAG_24_ALSO_CELL_FLAG_CONST == CELL_FLAG_CONST);
...
typedef struct {
    ...
    // logical length in such cases is in MISC_STRAND_NUM_CODEPOINTS
    //
    Length used;
