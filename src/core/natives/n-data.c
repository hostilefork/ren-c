...
//      value [<cond> element?]  ; QUOTED? support?
//  ]
//
...
//      value [<cond> any-list?]  ; QUOTED? support?
//  ]
//
...
//          [integer! any-context?]
//      value [<const> <cond> any-word? any-list?]  ; QUOTED? support?
//  ]
//
...
//
//      return: ~
//      memory [<cond> any-series? any-context? handle!]
//  ]
//
DECLARE_NATIVE(FREE)
{
