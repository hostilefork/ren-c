...
(null? replace:one copy [3 0 4] 0 veto)
(null? replace:one copy [3 0 4] veto 1020)
(null? replace veto spread [1 0] 20)

; REPLACE with VOID - legal for replacement, but not pattern at this time
; (if FIND took VOID for the pattern, REPLACE would too)
...
;
(#{1000200010002000} = replace copy #{1000200010002000} #{1000} does [veto])
