...
(error? rescue [1 / 0])
(not error? 1)
(error! = type of rescue [1 / 0])

; error evaluation
(error? eval head of insert copy [] rescue [1 / 0])
...
;
(rescue [make error! [type: 'script id: 'nonexistent-id]] then [okay])

; triggered errors should not be assignable
;
(a: 1 error? rescue [a: 1 / 0] a = 1)
(a: 1 error? rescue [set $a 1 / 0] a = 1)
(a: 1 error? rescue [set $a 1 / 0] a = 1)
...
(error? make error! [type: 'script id: 'bad-pick])
(error? make error! [type: 'script id: 'bad-poke])
...
(error? make error! [type: 'script id: 'parse3-rule])
(error? make error! [type: 'script id: 'parse3-end])
(error? make error! [type: 'script id: 'parse3-variable])
(error? make error! [type: 'script id: 'parse3-command])
(error? make error! [type: 'script id: 'parse3-series])
(error? make error! [type: 'script id: 'bad-utf8])
(error? make error! [type: 'script id: 'exhausted])
