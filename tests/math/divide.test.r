...
<32bit>
(error? rescue [divide -2147483648 -1])
(error? rescue [divide -2147483648 0])
...
(error? rescue [divide -1073741824 0])
(-1073741824 = divide -1073741824 1)
(-536870912 = divide -1073741824 2)
(-1 = divide -1073741824 1073741824)
(1 = divide -2 -2)
(2 = divide -2 -1)
(error? rescue [divide -2 0])
(-2 = divide -2 1)
(-1 = divide -2 2)
(0.5 = divide -1 -2)
(1 = divide -1 -1)
(error? rescue [divide -1 0])
(-1 = divide -1 1)
(-0.5 = divide -1 2)
...
(error? rescue [divide 2147483647 0])
(2147483647 = divide 2147483647 1)
(1073741823.5 = divide 2147483647 2)
(1 = divide 2147483647 2147483647)
(10.0 = divide 1 0.1)
