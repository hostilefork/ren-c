...
[
    ...
    (
        res: '~before~
        all [
            failure? parse [a a] [res: across repeat 3 'a]
            res = '~before~
        ]
    )
    (
    ...
    (
        res: '~before~
        all [
            failure? parse [a] [res: across ['c | 'b]]
            res = '~before~
        ]
    )
    (
...
[
    ...
    (
        v: '~before~
        all [
            failure? parse:part input [v: across repeat 3 one] 2
            v = '~before~
        ]
    )
    (
    ...
    (
        v: ~
        all [
            failure? parse:part input [v: across repeat 3 one] 4
            v = [h 5 #l]
        ]
    )
    (
    ...
    (
        v: '~before~
        all [
            failure? parse:part input [v: across to 'o one] 3
            v = '~before~
        ]
    )
    (
    ...
    (
        v: '~before~
        all [
            failure? parse:part input2 [v: across repeat 3 'a] 2
            v = '~before~
        ]
    )
    (
    ...
    (
        v: '~before~
        all [
            failure? parse:part input [v: across repeat 3 one] skip input 2
            v = '~before~
        ]
    )
    (
    ...
    (
        v: ~
        all [
            failure? parse:part input [v: across repeat 3 one] skip input 4
            v = [h 5 #l]
        ]
    )
    (
    ...
    (
        v: '~before~
        all [
            failure? parse:part input [v: across to 'o one] skip input 3
            v = '~before~
        ]
    )
    (
    ...
    (
        v: '~before~
        all [
            failure? parse:part input2 [v: across repeat 3 'a] skip input2 2
            v = '~before~
        ]
    )
    (
...
[
    ...
    (
        res: '~before~
        all [
            failure? parse "aa" [res: across repeat 3 #a]
            res = '~before~
        ]
    )
    (
...
[
    ...
    (
        v: '~before~
        all [
            failure? parse:part input [v: across repeat 3 letters] 2
            v = '~before~
        ]
    )
    (
    ...
    (
        v: '~before~
        all [
            failure? parse:part input [v: across repeat 3 letters] skip input 2
            v = '~before~
        ]
    )
    (
...
[
    ...
    (
        res: '~before~
        all [
            failure? parse #{0A0A} [res: across repeat 3 #{0A}]
            res = '~before~
        ]
    )
    (
    ...
    (
        res: '~before~
        all [
            failure? parse #{0A} [res: across [#"^L" | #{0B}]]
            res = '~before~
        ]
    )
    (
...
[
    ...
    (
        v: '~before~
        all [
            failure? parse:part input2 [v: across repeat 3 #{0A}] 2
            v = '~before~
        ]
    )
    (
    ...
    (
        v: '~before~
        all [
            failure? parse:part input [v: across skip 3] skip input 2
            v = '~before~
        ]
    )
    (
    ...
    (
        v: '~before~
        all [
            failure? parse:part input2 [v: across repeat 3 #{0A}] skip input2 2
            v = '~before~
        ]
    )
    (
